...
- [ ] Reconcile snapshot fetch reads all relevant pages.
- [ ] Input IDs that exist in later pages are accepted.
- [ ] Integration test covers >1 page unreconciled data.
- [ ] Existing reconcile tests continue passing.
...
- Blocks merge because it can cause incorrect reconcile failures in production-scale tenants.
